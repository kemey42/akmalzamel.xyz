...
// Akmal: Use d-none to hide unwanted section instead of delete
var templates = {
  Stream: '<div class="gha-feed list-group">{{{text}}}<div class="gha-push-small d-none"></div>{{{footer}}}</div>',
  Activity: '<div id="{{id}}" class="gha-activity gha-small list-group-item">\
  ...
  SingleLineActivity: '<div class="gha-activity gha-small list-group-item">\
                         <div class="gha-activity-icon"><span class="octicon octicon-{{icon}}"></span></div>\
                         <div class="gha-message"><div class="gha-time">{{{timeString}}}</div>{{{userLink}}} {{{message}}}</div>\
                         <div class="gha-clear"></div>\
                       </div>',
  UserHeader: '<div class="gha-header list-group-item d-none">\
               ...
               </div><div class="gha-push d-none"></div>',
  Footer: '<div class="gha-footer list-group-item d-none">Public Activity <a href="https://github.com/caseyscarborough/github-activity" target="_blank">GitHub Activity Stream</a>',
  NoActivity: '<div class="gha-info list-group-item">This user does not have any recent public activity.</div>',
  UserNotFound: '<div class="gha-info list-group-item">User {{username}} wasn\'t found.</div>',
  EventsNotFound: '<div class="gha-info list-group-item">Events for user {{username}} not found.</div>',
